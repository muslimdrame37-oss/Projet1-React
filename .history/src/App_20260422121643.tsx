        ...
        <section className="mt-10">
          <Container>
            ...
            <div className='flex items-center justify-between gap-4'>
              ...
              <div className='bg-[url(/src/img/chaussurehomme.jpeg)] w-1/4 h-110 bg-cover bg-center'>
                <Button variant="secondary" className='text-3xl px-8 py-4 mb-4 bg-white opacity-90 hover:opacity-100'>
                  <p>Chaussures</p>
                </Button>
              </div>
              <div className='bg-[url(/src/img/montre.jpeg)] w-1/4 h-110 bg-cover bg-center'>
                <Button variant="secondary" className='text-3xl px-8 py-4 mb-4 bg-white opacity-90 hover:opacity-100'>
                  <p>Montres</p>
                </Button>
              </div>
