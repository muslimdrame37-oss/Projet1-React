        ...
        <section className="mt-10">
          <Container>
            ...
            <div className='flex items-center justify-between gap-4'>
              <div className='bg-[url(/src/img/chapeau.jpeg)] w-1/4 h-110 bg-cover bg-center'>
              <Button variant="primary" className='absolute bottom-4 left-1/2 -translate-x-1/2 gap-1'>
                <p>Voir plus</p>
                <MoveRight />
              </Button>
              </div>
