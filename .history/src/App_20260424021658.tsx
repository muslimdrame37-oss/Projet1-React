    ...
    <body className=" ">
      ...
      <main>
          ...
          <Container>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 ">
              {productList.map((produit, index) => (
                <div key={index} className="rounded-2xl bg-white p-4 shadow-md hover:shadow-lg transition-shadow">
                  <img
                    src={produit.image}
                    alt={produit.title}
            ...
            <div className="flex flex-col items-center justify-center gap-15">
              ...
              <div className="flex gap-8 ">
                {storyList.map((story, index) => (
                  <div key={index}>
                    <img className="h-80 rounded-2xl shadow-sm shadow-gray-400 hover:shadow-lg" src={story.image} alt="" />
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="mt-25">
          <Container>
            <div className="flex items-center justi gap-8">
              <div>
