      ...
      <footer className="flex flex-col items-center justify-between bg-black h-100 mt-30 pt-15">
        <Container>
          <div className="grid grid-cols-4 gap-8">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-white font-extrabold text-3xl">Informations</h2>
            ...
            <div className="flex flex-col gap-3 text-white">
              <h2 className="text-white font-extrabold text-3xl">Souscription</h2>
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tenetur saepe nulla nisi inventore molestias architecto soluta quis quia praesentium sapiente explicabo, iste aliquam, facere rerum dolore, minima commodi earum? Totam?</p>
            </div>
          </div>
        </Container>
