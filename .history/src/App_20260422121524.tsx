        ...
        <section className="mt-10">
          <Container>
            ...
            <div className='flex items-center justify-between gap-4'>
              ...
              <Button variant="secondary" className='px-8 py-4 mb-4 border-none bg-white opacity-90 hover:opacity-100'>
                <p>Chapeaux</p>
              </Button>
              </div>
              <div className='bg-[url(/src/img/costumes.jpeg)] w-1/4 h-110 bg-cover bg-center'></div>
              <div className='bg-[url(/src/img/chaussurehomme.jpeg)] w-1/4 h-110 bg-cover bg-center'></div>
              <div className='bg-[url(/src/img/montre.jpeg)] w-1/4 h-110 bg-cover bg-center'></div>
            </div>
          </Container>
        </section>
