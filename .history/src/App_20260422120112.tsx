        ...
        <section className="mt-10">
          <Container>
            ...
            <div className='flex items-center justify-between gap-4'>
              <div className='bg-url(/src/img/Category1.jpeg) w-1/4 h-64 bg-cover bg-center'></div>
              <div className='bg-url(/src/img/Category2.jpeg) w-1/4 h-64 bg-cover bg-center'></div>
              <div className='bg-url(/src/img/Category3.jpeg) w-1/4 h-64 bg-cover bg-center'></div>
