        ...
        <section className="mt-10">
          <Container>
            ...
            <div className='flex items-center justify-between gap-4'>
              <div className='bg-[url(/src/img/chapeau.jpeg)] w-1/4 h-sreen bg-cover bg-center'></div>
              ...
              <div className='bg-[url(/src/img/montre.jpeg)] w-1/4 h-64 bg-cover bg-center'></div>
            </div>
          </Container>
        </section>
