        ...
        <section className='mt-10'>
          <Container className='relative h-screen flex items-center bg-gray-100 justify-center gap-6 px-8'>
            ...
            <div className="relative w-1/3">
              <img src="/src/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg" alt="" className='w-full rounded-2xl' />
              <p className="absolute bottom-0 left-1/2 transform -translate-x-1/2 text-[13rem] font-extrabold text-gray-50">BESTBEST</p>
            </div>
          </Container>
        </section>
