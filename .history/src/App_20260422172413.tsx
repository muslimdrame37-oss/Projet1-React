...
function App() {
  return (
    <body className=" ">
      <header className="container mx-auto px-4 py-8 bg-amber-300">
      ...
      <main>
        ...
        <section className="container max-w-7xl mx-auto mt-5">
          <Container className="relative flex items-center bg-gray-100 justify-center gap-6 px-8">
            ...
            <img
              src="/src/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg"
              alt=""
        ...
        {/* section catégorie */}
        <section className="container max-w-7xl mx-auto mt-10">
          <Container>
            ...
            <div className="flex items-center justify-between gap-4 mt-10 ">
              <div className="flex items-end justify-center bg-[url(/src/img/chapeau.jpeg)] w-1/4 h-110 bg-cover bg-center rounded-2xl">
                <Button
                  variant="secondary"
                  className="text-2xl px-20 py-4 mb-4 border-none bg-white hover:opacity-100"
                >
                  <p>Chapeaux</p>
                </Button>
              </div>
