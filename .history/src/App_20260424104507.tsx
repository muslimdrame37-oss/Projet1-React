  ...
  return (
    <body className=" ">
      ...
      <footer className="flex flex-col items-center justify-between bg-black h-100 mt-30 pt-15">
        ...
        <Container>
          <div className="flex items-center justify-between w-full text-white bg-amber-100 py-4">
            <div className="flex gap-2">
              <img src="/img/Visa-Logo-2006.png" alt="" className="w-13 bg-white"/>
              <img src="/img/mastercard.png" alt="" className="w-13 bg-white"/>
              <img src="/img/Google_Pay_Logo.svg.png" alt="" className="w-13 bg-white"/>
              <img src="/img/american-express-logo-freelogovectors.net_-1.png" alt="" className="w-13 bg-white"/>
              <img src="/img/Logo_PayPal_1.png" alt="" className="w-13 bg-white"/>
            </div>
            <div className="text-sm">&copy; 2024 Ventout. Tous droits réservés. Conçu par Ventout Team.</div>
            <div className="flex gap-4">
              <FaFacebookF size={20} />
              <FaInstagram size={20} />
              <FaTwitter size={20} />
