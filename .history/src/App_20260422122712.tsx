        ...
        <section className="mt-10">
          <Container>
            ...
            <div className='flex items-center justify-between gap-4 mt-10 '>
              ...
              <Button variant="secondary" className='text-3xl px-20 py-4 mb-4 border-none bg-white hover:opacity-100'>
                <p>Chapeaux</p>
              </Button>
              </div>
              <div className='flex items-end justify-center bg-[url(/src/img/costumes.jpeg)] w-1/4 h-110 bg-cover bg-center rounded-2xl'>
                <Button variant="secondary" className='text-3xl px-8 py-4 mb-4 border-none bg-white hover:opacity-100'>
                  <p>Costumes</p>
                </Button>
              </div>
