    ...
    <body className='container mx-auto px-4 py-8 '>
      ...
      <main>
        ...
        <section className="mt-10">
          <Container>
            <div>
              <p className="text-lg">Nos Catégories</p>
              <div>
                <Button variant="secondary" className='mt-4'>Voir tout</Button>
                <Button variant="secondary" className='mt-4 ml-4'>Voir tout</Button>
              </div>
            </div>
          </Container>
        </section>
