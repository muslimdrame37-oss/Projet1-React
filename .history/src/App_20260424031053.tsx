...
import { Heart, PhoneForwarded } from "lucide-react";
...
function App() {
  return (
    <body className=" ">
      ...
      <footer className="bg-black h-100 mt-30 pt-15">
        <Container>
          <div className="grid grid-cols-4 gap-8 bg-amber-300">
            <div className="flex flex-col gap-3 bg-amber-600">
              <div className="flex items-center bg-amber-950 justify-center w-40 h-20 bg-white rounded-2xl px-2">
