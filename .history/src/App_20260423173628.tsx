...
import { Cotainer } from "./composants/container";
...
const CardList = [
  {
    image: "/src/assets/img/costumes.jpeg",
    buttonText: "Découvrir",
  },

  {
    image: "/src/assets/img/chapeau.jpeg",
    buttonText: "Découvrir",
  },

  {
    image: "/src/assets/img/montre.jpeg",
    buttonText: "Découvrir",
  },

  {
    image: "/src/assets/img/Broderie_Homme.jpeg",
    buttonText: "Découvrir",
  },
];
    ...
    <body className=" ">
      <header className="container mx-auto px-4 py-8 shadow-md">
        <Container className="flex justify-between items-center">
          <img src="/src/assets/img/Logo + Text.png" alt="" width={140} />
      ...
      <main>
        ...
        <section className="container max-w-7xl mx-auto mt-5">
          <Container className="relative flex items-center bg-gray-100 justify-center gap-6 px-8">
            ...
            <img
              src="/src/assets/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg"
              alt=""
