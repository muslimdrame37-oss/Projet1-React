        ...
        <section className="mt-10">
          <Container>
            ...
            <div className='flex items-center justify-between gap-4'>
              <div className='bg-[url(/src/img/chapeau.jpeg)] w-1/4 h-64 bg-cover bg-center'></div>
              <div className='bg-[url(/src/img/costumes.jpeg)] w-1/4 h-64 bg-cover bg-center'></div>
              <div className='bg-[url(/src/img/chaussurehomme.jpeg)] w-1/4 h-64 bg-cover bg-center'></div>
              <div className='bg-[url(/src/img/Category4.jpeg)] w-1/4 h-64 bg-cover bg-center'></div>
            </div>
          </Container>
        </section>
