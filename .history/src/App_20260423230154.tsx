      ...
      <main>
        ...
        <section className="mt-20">
          <Container className="flex items-center justify-center gap-8"> 
            <div className="w-1/2">
              <h2 className="text-5xl font-semibold">L'affaire du Mois</h2>
              <p className="text-lg text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint sapiente obcaecati totam earum laudantium ullam natus eius tempore? Libero necessitatibus placeat iusto minus nam temporibus neque sunt et quibusdam quos.</p>
              ...
              <Button className="gap-3 py-4 text-sm">
                Voir tous nos articles
                <MoveRight />
              </Button>
            </div>
            {/* <div className="flex items-center justify-center py-2 w-1/2 shadow-2xl">
            </div> */}
            <img src="/img/Tenue Mariage Homme.jpeg" alt="" className="w-90 h-full rounded-lg shadow-2xl"/>
          </Container>
        </section>
      </main>
    </body>
