        ...
        <section className="mt-50">
          <Container>
            ...
            <div className='grid grid-cols-4 gap-4 mt-10 '>
              ...
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/Complet Tunique Homme.jpeg" alt="" className='rounded-2xl mb-4' />
              ...
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/Broderie Homme.jpeg" alt="" className='rounded-2xl mb-4' />
              ...
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/Boubou Africain Homme.jpeg" alt="" className='rounded-2xl mb-4' />
              ...
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/BENYAR Mens Watches Quartz Chronograph Business Luxury Brand Waterproof Wristwatches Fashion Brown Leather Watches for Men.jpeg" alt="" className='rounded-2xl mb-4' />
                <p className='text-lg font-bold'>Costume Décontracté</p>
                <p className='text-md text-gray-400'>100% coton</p>
                <div className='flex gap-2'>
                  <p className='text-gray-600'>$179.99</p>
              ...
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/2023 Nova Chegada De Sandálias Casuais Masculinas Da Moda.jpeg" alt="" className='rounded-2xl mb-4' />
                <p className='text-lg font-bold'>Costume Décontracté</p>
                <p className='text-md text-gray-400'>100% coton</p>
                <div className='flex gap-2'>
                  <p className='text-gray-600'>$179.99</p>
              ...
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/Modèle Super Cent Homme.jpeg" alt="" className='rounded-2xl mb-4' />
                <p className='text-lg font-bold'>Costume Décontracté</p>
                <p className='text-md text-gray-400'>100% coton</p>
                <div className='flex gap-2'>
                  <p className='text-gray-600'>$179.99</p>
              ...
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/SHUZIA Women's Boston Clog Wide Fit Burgundy Slip On Mule Holiday Vacay Vibe For And Summer Shoes Spring Shoes Spring Break Easter.jpeg" alt="" className='rounded-2xl mb-4' />
                <p className='text-lg font-bold'>Costume Décontracté</p>
                <p className='text-md text-gray-400'>100% coton</p>
                <div className='flex gap-2'>
                  <p className='text-gray-600'>$179.99</p>
