        ...
        <section className="bg-gray-50 py-20 mt-20">
          <Container className="flex flex-col gap-15">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="flex flex-col bg-white gap-4 rounded-lg shadow px-6 py-4">
                ...
                <div className="flex gap-4">
                  ...
                  />
                  <div className="">
                    <div className="font-bold">Serigne Massamba</div>
                    <div className="text-sm">Serigne Daara</div>
                  </div>
                </div>
              </div>
            </div>
