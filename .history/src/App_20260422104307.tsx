    ...
    <body className='container mx-auto px-4 py-8 '>
      ...
      <main>
        ...
        <section className='mt-10'>
          <Container className='relative h-full flex items-center bg-gray-100 justify-center gap-6 px-8'>
            <div className="relative flex flex-col items-start w-1/2 gap-4">
              ...
              <p className="absolute top-30 left-33 text-[13rem] font-extrabold text-gray-50">BESTBEST</p>
            </div>
            <img src="/src/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg" alt="" className='absolute inset-0 w-1/3 rounded-2xl' />
          </Container>
        </section>
