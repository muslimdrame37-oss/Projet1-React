          ...
          <Container>
            ...
            <div className='grid grid-cols-4 gap-4 mt-10 '>
              ...
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/costume1.jpeg" alt="" className='rounded-2xl mb-4' />
              ...
              card 2
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/costume2.jpeg" alt="" className='rounded-2xl mb-4' />
              ...
              card 3
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/costume3.jpeg" alt="" className='rounded-2xl mb-4' />
              ...
              card 4
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img/costume4.jpeg" alt="" className='rounded-2xl mb-4' />
