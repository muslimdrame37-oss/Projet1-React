    ...
    <body className='container mx-auto px-4 py-8 '>
      ...
      <main>
        ...
        <section className='mt-10'>
          <Container className='flex items-center bg-gray-100 justify-center gap-6 px-8'>
            ...
            <div className=''>
              <div></div>
              <img src="/src/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg" alt="" className='absolute inset-0 z-10 w-1/3 rounded-2xl' />
