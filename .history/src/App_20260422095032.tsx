    ...
    <body className='container mx-auto px-4 py-8 '>
      ...
      <main>
        ...
        <section className='mt-10'>
          <Container className='flex items-center bg-gray-100 justify-center gap-2'>
            <div className="flex flex-col items-start w-1/2 gap-2">
              ...
              <p className="text-lg text-gray-600">Plus de 1000 articles disponibles</p>
              <Button variant="primary">Shop Now</Button>
            </div>
            <img src="/src/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg" alt="" className='w-1/3' />
          </Container>
        </section>
