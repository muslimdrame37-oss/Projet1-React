      ...
      <main>
        ...
        <section className='mt-10'>
          <Container className='relative h-screen flex items-center bg-gray-100 justify-center gap-6 px-8'>
            ...
            <div className="relative w-1/3 flex jus">
              <p className="absolute top-20 left-1/3 transform -translate-x-2/3 text-[13rem] font-extrabold text-gray-50">BESTBEST</p>
              <img src="/src/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg" alt="" className='absolute w-full rounded-2xl' />
            </div>
          </Container>
        </section>
