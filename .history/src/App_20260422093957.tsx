  ...
  return ( 
    <body className='container mx-auto px-4 py-8 '>
      ...
      <main>
        {/* hero section */}
        <section>
          <Container className='flex items-center content-center bg-gray-100 height- text-center gap-6 py-16'>
            ...
            <img src="/src/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg" alt="" className='w-1/2 mx-auto' />
          </Container>
        </section>
