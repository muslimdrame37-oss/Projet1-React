...
const CardList = [
  {
    image: "/src/img/costumes.jpeg",
    buttonText: "Découvrie"
  },

  {
    image: "/src/img/chapeaux.jpeg",
    buttonText: "Salam"
  },
  ...
  {
    image: "/src/img/Broderie Homme.jpeg",
    buttonText: "Salam"
  },
]
        ...
        <section className="container max-w-7xl mx-auto mt-15">
          <Container>
            ...
            <div className="flex items-center justify-between flex-wrap gap-4 mt-10 ">
              <Card image="/src/img/costumes.jpeg" buttonText="Salut"/>
              <Card image="/src/img/costumes.jpeg" buttonText="Salut"/>
              <Card image="/src/img/costumes.jpeg" buttonText="Salut"/>
              <Card image="/src/img/costumes.jpeg" buttonText="Salut"/>
              <Card image="/src/img/costumes.jpeg" buttonText="Salut"/>
