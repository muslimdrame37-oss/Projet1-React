        ...
        <section className='mt-10'>
          <Container className='relative h-screen flex items-center bg-gray-100 justify-center gap-6 px-8'>
            ...
            <div className="relative w-1/3 flex items-center justify-center">
              <p className="absolute top-30  text-[13rem] font-extrabold text-gray-50">BESTBEST</p>
              <img src="/src/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg" alt="" className='absolute w-full h-screen rounded-2xl' />
            </div>
          </Container>
        </section>
