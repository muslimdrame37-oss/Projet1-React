        ...
        <section className="mt-20">
          <Container className="flex items-center justify-between gap-20">
            ...
            <img
              ...
              alt=""
              className="w-2/6 h-full rounded-lg shadow-2xl"
            />
          </Container>
        </section>
            ...
            <div className="flex gap-6">
              <div className="bg-white rounded-lg shadow p-4">
                ...
                <p>
                  ...
                  libero? Nostrum optio neque eos debitis impedit officiis ut,
                  obcaecati est dolore culpa qui distinctio aut, facere eius,
                  rem sit quod. Autem iusto obcaecati odio, eius dolorem quos
                  quidem, suscipit soluta provident officia nisi tempora, amet
                  nihil est voluptate corrupti animi quam! Dolore ex eveniet
                  dolorum doloremque. Neque sit officia dolorum!
                </p>

                <div>
                <img src="/img/Modèle Super Cent Homme.jpeg" alt="" width={15} height={15} className="rounded-all"/>
                <div>
                  <div>Serigne Massamba</div>
                  <div>Serigne Daara</div>
                </div>
              </div>
              </div>
