        ...
        <section className="mt-50">
          <Container>
            ...
            <div className='grid grid-cols-4 gap-4 mt-10 '>
              ...
              <div className='bg-white rounded-2xl p-4'>
                <img src="/src/img//Users/Muslim/Documents/Les cours/Codage/cours_react/my-project/src/img/2023 Nova Chegada De Sandálias Casuais Masculinas Da Moda.jpeg.jpeg" alt="" className='rounded-2xl mb-4' />
                <p className='text-lg font-bold'>Costume Décontracté</p>
                <p className='text-md text-gray-400'>100% coton</p>
                <div className='flex gap-2'>
                  <p className='text-gray-600'>$179.99</p>
