    ...
    <body className='container mx-auto px-4 py-8 '>
      ...
      <main>
        ...
        <section className='mt-10'>
          <Container className='flex items-center bg-gray-100 justify-between gap-6'>
            ...
            <img src="/src/img/Quiet Luxury Weekend Style _ Men's Smart Casual Outfit.jpeg" alt="" className='w-1/3 px-15' />
          </Container>
        </section>
