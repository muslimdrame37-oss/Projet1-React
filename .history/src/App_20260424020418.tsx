    ...
    <body className=" ">
      ...
      <main>
          ...
          <Container className="flex flex-col gap-15">
            ...
            <div className="grid grid-cols-3 gap-6">
              {avisList.map((avis, index) => (
                <div
                  key={index}
                  className="flex flex-col bg-white gap-4 rounded-lg shadow px-6 py-4"
                >
                  <div>
        ...
        <section className="mt-30">
          <Container>
            <div className="flex bg-amber-700 flex-col items-center justify-center gap-6">
              <h2 className="text-5xl font-semibold">Nos Stories Instagram</h2>
              <div className="flex gap-8 bg-amber-950">
                {storyList.map((story, index) => (
                  <div key={index}>
                    <img className="h-90" src={story.image} alt="" />
                  </div>
                ))}
              </div>
            </div>
