          ...
          <Container>
            ...
            <div className="flex gap-6">
              <div className="bg-white rounded-lg shadow p-4">
                ...
                obcaecati est dolore culpa qui distinctio aut, facere eius, rem
                sit quod. Autem iusto obcaecati odio, eius dolorem quos quidem,
                suscipit soluta provident officia nisi tempora, amet nihil est
                voluptate corrupti animi quam! Dolore ex eveniet dolorum
                doloremque. Neque sit officia dolorum!
                </p>
              </div>
            </div>
          </Container>
